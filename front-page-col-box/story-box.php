<div id="story_col" class="middle-col middle-col-right">
	<div id="main-middle-col6" class="title-box">
		<div class="title">
			<h3>토지+자유 이야기</h3>
			<a href="<?php echo getStoryPageURL() ?>" ><span class="more">+</span></a>
		</div>
	</div>
	<div class="front-col-content">
		<?php
		$args = array(
				'cat' => getStoryCategoryNum(),
				'posts_per_page' => 2,
				);
